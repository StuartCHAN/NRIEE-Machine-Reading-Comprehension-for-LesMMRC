...
home = os.getcwd()
train_file = os.path.join(home, "{datasets}", "{data_file}.json")
dev_file = train_file 
test_file = train_file 
glove_word_file = os.path.join(home, "data_samples", "word_emb.npy")

train_dir = "train"
model_name = "ZhongDian28"
...
word_emb_file = os.path.join(target_dir, "word_emb.npy")
char_emb_file = os.path.join(target_dir, "char_emb.npy")
train_eval = os.path.join(target_dir, "train_eval.json")
train_examples = os.path.join(target_dir, "train_examples.json")#
...
flags.DEFINE_string("train_examples_file", train_examples, "Out file for train examples")#
